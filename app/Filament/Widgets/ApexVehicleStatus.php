...
use App\Traits\VehiculoStatusTrait;
use Leandrocfe\FilamentApexCharts\Widgets\ApexChartWidget;

class ApexVehicleStatus extends ApexChartWidget
{

    use VehiculoStatusTrait;

    protected static string $chartId = 'apexVehicleStatus';
